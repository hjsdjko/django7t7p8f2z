...
<!-- 商品推荐 -->
<div id="animate_recommendbaijiu" class="recommend animate__animated" :style='{"padding":"40px 7% 40px","margin":"0 auto","borderColor":"#ddd","flexWrap":"wrap","background":"none","borderWidth":"0px 0","display":"flex","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"0 auto","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240117/e2da3af842f44f9f86c61d0ff295414d.png) no-repeat center center / 35%","height":"60px"}'>
		<span :style='{"padding":"0px 0 0","fontSize":"26px","lineHeight":"60px","color":"#454545","fontWeight":"600","display":"block"}'>白酒推荐</span>
	</div>
		...
		<div v-if="baijiuRecommend.length" :style='{"padding":"0","margin":"10px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"3"}' class="list list17 index-pv1">
		  <div v-for="item,index in baijiuRecommend" :key="index"  @click="toDetail('baijiuDetail', item)" :style='{"cursor":"pointer","width":"calc(25% - 20px)","margin":"0 20px 20px 0","position":"relative","background":"none","height":"auto"}' class="item">
			<div class="content">
		      <div class="info">
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">{{item.jiage}}</div>
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">{{item.xiaoshoue}}</div>
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">{{item.xiaoshouliang}}</div>
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">{{item.chandi}}</div>
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">{{item.shangjiaxinxi}}</div>
	...
	<div @click="moreBtn('baijiu')" :style='{"border":"0px solid #eccc19","cursor":"pointer","padding":"0 20px","margin":"0","borderRadius":"20px","textAlign":"RIGHT","background":"none","display":"block","width":"100%","lineHeight":"32px"}'>
		<span :style='{"color":"#3389d7","fontSize":"22px"}'>MORE</span>
		<i :style='{"color":"#3389d7","fontSize":"22px","display":"inline-block"}' class="icon iconfont icon-jiantou25"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendbaijiu',css:'animate__'},
      ...
      preHttp(str) {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "baijiu/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "baijiu/autoSort2";
          }
			data = {
				page: 1,
				limit: 8,
			...
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.baijiuRecommend = res.data.data.list;
