	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0 7%","borderColor":"#eee","alignItems":"center","color":"#fff","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#111","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"32px","position":"relative","borderStyle":"solid","height":"36px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","left":"7%","display":"inline-block","width":"auto","position":"absolute","float":"left","height":"32px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"26px","float":"left","fontWeight":"600","height":"32px"}'>基于python的白酒数据推荐系统</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-wenzi","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除","商家信息","产地","价格","销售额","销售量","查看评论","导出","导入","上传模板","下载模板","首页总数","首页统计"],"appFrontIcon":"cuIcon-medal","buttons":["新增","查看","修改","删除","查看评论","导出","导入","上传模板","下载模板"],"menu":"白酒","menuJump":"列表","tableName":"baijiu"}],"menu":"白酒管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-medal","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","商家信息","产地","价格","销售额","销售量","查看评论","导出","导入","上传模板","下载模板","首页总数","首页统计"],"appFrontIcon":"cuIcon-phone","buttons":["查看"],"menu":"白酒列表","menuJump":"列表","tableName":"baijiu"}],"menu":"白酒模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","商家信息","产地","价格","销售额","销售量","查看评论","导出","导入","上传模板","下载模板","首页总数","首页统计"],"appFrontIcon":"cuIcon-phone","buttons":["查看"],"menu":"白酒列表","menuJump":"列表","tableName":"baijiu"}],"menu":"白酒模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
