...
<div class="content" :style='{"minHeight":"100vh","padding":"30px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240414/b272aea717df4bbe8386c71c24c14e6e.png) no-repeat center top / cover","display":"flex","width":"100%","height":"auto"}'>
	...
	<div :style='{"width":"50%","margin":"0","grid-template-columns":"repeat(2,1fr)","display":"grid","rowGap":"20px","order":"2"}'>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","alignItems":"center","background":"#fff","display":"flex","position":"relative","justifyContent":"center"}' v-if="isAuth('baijiu','首页总数')">
			...
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#333","fontWeight":"bold","height":"24px"}'>{{baijiuCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>白酒总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 5 -->
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","margin":"20px 0 0","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="baijiuChart1" class="echarts1" v-if="isAuth('baijiu','首页统计')"></div>
		<div id="baijiuChart2" class="echarts2" v-if="isAuth('baijiu','首页统计')"></div>
		<div id="baijiuChart3" class="echarts3" v-if="isAuth('baijiu','首页统计')"></div>
		<div id="baijiuChart4" class="echarts4" v-if="isAuth('baijiu','首页统计')"></div>
		<div id="baijiuChart5" class="echarts5" v-if="isAuth('baijiu','首页统计')"></div>
	</div>
</div>
</template>
<script>
